            ...
            if zedd == '2':
                ...
                if zedd == '3':
                    ...
                    if zedd == '4':
                        ...
                        if zedd == '5':
                            os.system('rm -rf login.txt')
                            os.system('xdg-open https://www.youtube.com/hacking 04')
                            keluar()
                        else:
                            if zedd == '0':
                                keluar()
...
def menu_yahoo():
    ...
    print '\x1b[1;37;40m2. yahoofromfriends'
    print '\x1b[1;31;40m0. Kembali'
    print
    yahoo_pilih()
